...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link no corresponde a una invitación válida. Revisa la URL o pídele a quien te invitó que te envíe una nueva.',
  },
  used: {
    title: 'La invitación ya fue usada',
    body: 'Esta invitación ya fue aceptada. Si no fuiste tú, pídele al administrador de la cuenta que envíe un link nuevo.',
  },
  expired: {
    title: 'Invitación vencida',
    body: 'Esta invitación venció. Pídele al administrador de la cuenta que envíe una nueva — se genera en unos segundos.',
  },
  server_error: {
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            ...
            <div className="space-y-2 py-2 text-xs text-muted-foreground">
              <p>
                ...
                cierra sesión y regístrate de nuevo con un correo distinto.
                El link de invitación sigue siendo válido mientras no haya
                vencido.
              </p>
            </div>
